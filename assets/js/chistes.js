(function () {
    ...
    function makeCard(j) {
        ...
        const idiomaEl = node.querySelector('.chiste-idioma');
        if (j.idioma) {
            idiomaEl.textContent = idiomaFlag(j.idioma);
            idiomaEl.title = j.idioma;
            idiomaEl.style.display = '';
        }
    ...
    function idiomaFlag(idioma) {
        const flags = { 'español': '🇪🇸', 'inglés': '🇬🇧', 'alemán': '🇩🇪', 'catalán': '🏴󠁥󠁳󠁣󠁴󠁿' };
        return flags[idioma] || idioma;
    }
