...
<form id="chiste-form" class="form-card" data-id="<?= h($id) ?>">
    ...
    <div class="form-row">
        ...
        <div class="form-group">
            <label for="idioma"><?= h(t('idioma_label')) ?></label>
            <select id="idioma" name="idioma">
                <option value=""><?= h(t('idioma_any')) ?></option>
                <option value="español"  <?= ($chiste && ($chiste['idioma'] ?? '') === 'español')  ? 'selected' : '' ?>>🇪🇸 <?= h(t('lang_es')) ?></option>
                <option value="inglés"   <?= ($chiste && ($chiste['idioma'] ?? '') === 'inglés')   ? 'selected' : '' ?>>🇬🇧 <?= h(t('lang_en')) ?></option>
                <option value="alemán"   <?= ($chiste && ($chiste['idioma'] ?? '') === 'alemán')   ? 'selected' : '' ?>>🇩🇪 <?= h(t('lang_de')) ?></option>
                <option value="catalán"  <?= ($chiste && ($chiste['idioma'] ?? '') === 'catalán')  ? 'selected' : '' ?>>🏴󠁥󠁳󠁣󠁴󠁿 <?= h(t('lang_ca')) ?></option>
            </select>
        </div>
